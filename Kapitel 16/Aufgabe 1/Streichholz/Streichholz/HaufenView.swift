...
class HaufenView: UIView {
    ...
    func entferneHoelzer(anzahl: Int) {
        ...
        for var i=1; i<=entferneZahl; i+=1 {
            ...
            // Löse die erste Animation (die Drehung) aus.
            // ACHTUNG: Hier darf der completion-Block NICHT
            // stehen! Dieser gehört nun in den "langsameren" Teil.
            ...
            // Löse die zweite Animation (das Verschwinden) aus.
            // Die Dauer ist allerdings 2 Sekunden, also doppelt so lang.
            // ACHTUNG: Hier gehört jetzt der completion-Block hin!
